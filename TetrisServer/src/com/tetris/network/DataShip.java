...
public class DataShip implements Serializable{
	...
	public static final int SEND_BOARD=12;
	public static final int USING_ITEM = 13;
	public static final int MASTER_PLAYER = 14;
	public static final int SLAVE_PLAYER = 15;
	...
	public void setSendIndex(int sendIndex) {this.sendIndex = sendIndex;}
